  ...
  return (
    <article className="flow">
      ...
      <div className="program-container">
        <h3 className="program">Açılış Konuşması <br/>12.30 - 13.00</h3>
        <div className="speaker-container">
          <figure className="speaker">
              <img style={{padding:"20px"}} src={SkylabImage} alt="Konuşmacı" />
              <figcaption>
                <h3>SKY LAB</h3>
              </figcaption>
            </figure>
      ...
      <div className="program-container">
        <h3 className="program">Infinitum IT <br /> 13.00 - 13.40</h3>
        <div className="speaker-container">
          <figure className="speaker">
      ...
      <div className="program-container">
        <h3 className="program">ROKETSAN <br /> 14.40 - 15.20</h3>
        <div className="speaker-container">
            <figure className="speaker">
      ...
      <div className="program-container">
        <h3 className="program">ASELSAN <br /> 15.35 - 16.15</h3>
        <div className="speaker-container">
          <figure className="speaker">
              <img src="/src/assets/konusmacilar/aselsan/Tevfik.jpeg" alt="Konuşmacı" />
              <figcaption>
                <h3>Tevfik Demirel</h3>
                <p>Cyber Security Engineer <br/> Team Lead</p>
              </figcaption>
            </figure>
        </div>
      </div>
      <div className="program-container">
        <h3 className="program">SIEMENS <br /> 16.25 - 17.05</h3>
        <div className="speaker-container">
          <figure className="speaker">
      ...
      <div className="program-container">
        <h3 className="program">Siber Güvenlik 360 <br /> 17.15 - 17.55</h3>
        <div className="speaker-container">
          <figure className="speaker">
